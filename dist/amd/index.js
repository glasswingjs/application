define('index', ['exports', 'reflect-metadata', '@glasswing/common', '@glasswing/router', 'http', 'tsyringe', 'https', 'http2'], function (exports, reflectMetadata, common, router, http, tsyringe, https, http2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HttpsServerFactory = /** @class */ (function (_super) {
    ...
    var registerHttpsServerFactory = function () {
        return tsyringe.container.register('ServerFactory', {
    ...
    var Http2ServerFactory = /** @class */ (function () {
        ...
        Http2ServerFactory.prototype.create = function (router, options) {
            if (options === void 0) { options = {}; }
            return http2.createServer(options, function (req, res) {
                router(req, res);
            });
        };
    ...
    var Https2ServerFactory = /** @class */ (function (_super) {
        ...
        Https2ServerFactory.prototype.create = function (router, options) {
            if (options === void 0) { options = {}; }
            return http2.createSecureServer(options, function (req, res) {
                router(req, res);
            });
        };
        return Https2ServerFactory;
    }(Http2ServerFactory));
    var registerHttps2ServerFactory = function () {
        return tsyringe.container.register('ServerFactory', {
